...
# ─────────────────────────────────────────────────────
# Minimal RFC: 4행×3열 = 4 users × 3 weeks (row-major)
#   row1: 48780 (Feb, Aug, Nov)
#   row2: altitude_597802 (Dec, Oct, Mar)
#   row3: 28132 (Jan, Mar, Apr)
#   row4: altitude_48903 (Aug, Sep, Oct)
# ─────────────────────────────────────────────────────
PANEL_SPECS_12 = [
    # User 1
    {"base_key": "bms_01241248780_2023-02", "start": "21",    "end": "28"},
    {"base_key": "bms_01241248780_2023-08", "start": "8",     "end": "15"},
    {"base_key": "bms_01241248780_2023-11", "start": "4",     "end": "11"},

    # User 2 (altitude)
    {"base_key": "bms_altitude_01241597802_2023-12", "start": "22:18", "end": "29:18"},
    {"base_key": "bms_altitude_01241597802_2024-10", "start": "1",     "end": "8"},
    {"base_key": "bms_altitude_01241597802_2024-03", "start": "1",     "end": "8"},

    # User 3
    {"base_key": "bms_01241228132_2023-01", "start": "1:14",  "end": "8:14"},
    {"base_key": "bms_01241228132_2023-03", "start": "8",     "end": "15"},
    {"base_key": "bms_01241228132_2023-04", "start": "22",    "end": "29"},

    # User 4 (altitude)
    {"base_key": "bms_altitude_01241248903_2023-08", "start": "1",     "end": "8"},
    {"base_key": "bms_altitude_01241248903_2023-09", "start": "16",    "end": "23"},
    {"base_key": "bms_altitude_01241248903_2023-11", "start": "19",    "end": "26"},
]
...
def build_month_paths(vehicle_model: str, base_key: str) -> Tuple[str, str]:
    """
    non-DFC: {base_key}_R.csv 우선, 없으면 {base_key}_CR.csv fallback
...
# ─────────────────────────────────────────────────────
# 4×3 full-width Figure 생성 (Minimal)
# ─────────────────────────────────────────────────────
def make_suppl_minimal_4users_3weeks_fullwidth():
    cl = None
    ...
    out_base = os.path.join(BASE_OUT, "Suppl_Fig_Minimal_SCI")
...
if __name__ == "__main__":
    make_suppl_minimal_4users_3weeks_fullwidth()
